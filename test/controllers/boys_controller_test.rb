...
class BoysControllerTest < ActionController::TestCase
  ...
  test "should create boy" do
    assert_difference('Boy.count') do
      post :create, boy: { age: @boy.age, class: @boy.class, height: @boy.height, name: @boy.name, user_id: @boy.user_id, weight: @boy.weight }
    end
  ...
  test "should update boy" do
    patch :update, id: @boy, boy: { age: @boy.age, class: @boy.class, height: @boy.height, name: @boy.name, user_id: @boy.user_id, weight: @boy.weight }
    assert_redirected_to boy_path(assigns(:boy))
  end
